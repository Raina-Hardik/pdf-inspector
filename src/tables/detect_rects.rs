...
fn try_build_grid(
    ...
    // page background, because it is decoration, or because the column-count
    // guard above skipped propagation entirely.
    //
